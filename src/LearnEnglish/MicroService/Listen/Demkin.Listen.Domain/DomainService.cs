...
namespace Demkin.Listen.Domain
{
    public class DomainService : IDenpendencyScope
    {
        ...
        public async Task<Category> AddCategory(string title, string cover, int sequenceNum)
        {
            // 判断有没有这个Category
        ...
        public async Task<Album> AddAlbum(string title, string cover, int sequenceNum, long categoryId)
        {
